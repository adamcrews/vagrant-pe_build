...
module PEBuild::Release
  ...
  three_one_x = newrelease do
    ...
    set_answer_file :master, File.join(PEBuild.template_dir, 'answers', 'master-3.2.x.txt.erb')
    set_answer_file :agent,  File.join(PEBuild.template_dir, 'answers', 'agent-3.2.x.txt.erb')
  end
